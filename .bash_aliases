...
alias ngh='ng $(jq .name < package.json)'
...
alias nr='npm run'
alias nrs='npm run -s'
alias nu='npm i -g n ; n latest ; npm i -g npm@next ; node -v ; npm -v'
alias npmupd='nu ; npmu'
alias nt='npm test'
alias nde='npm dedupe'
alias npr='npm prune'
alias npmdp='npm dedupe && npm prune'
alias updateshrinkwrap='rm npm-shrinkwrap.json && npm i --save && npm ddp --save && npm prune --save && npm shrinkwrap'
