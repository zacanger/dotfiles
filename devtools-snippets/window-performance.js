  ...
  if(window.performance && window.performance.timing && window.performanceTrack !== false){
    ...
    function printTiming(t){
      ...
      if(timingContainer){
        var html = []
        var groups = {
            "Connection"             : function(){return t.connectEnd - t.connectStart}
          , "Response"               : function(){return t.responseEnd - t.responseStart}
          , "Domain Lookup"          : function(){return t.domainLookupEnd - t.domainLookupStart}
          , "Load Event"             : function(){return t.loadEventEnd - t.loadEventStart}
          , "Unload Event"           : function(){return t.unloadEventEnd - t.unloadEventStart}
          , "DOMContentLoaded Event" : function(){return t.domContentLoadedEventEnd - t.domContentLoadedEventStart}
        }
        for(var i in groups){
