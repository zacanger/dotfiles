...
{{
var G__15904 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15904;
continue;
}
} else
...
{var pred__15908 = cljs.core._EQ_;var expr__15909 = limit;if(cljs.core.truth_(pred__15908.call(null,1,expr__15909)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15908.call(null,2,expr__15909)))
...
var G__15911 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15912 = (limit__$1 - 1);
var G__15913 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15911;
limit__$1 = G__15912;
parts = G__15913;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___15915 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15915))
{var replacement_15916 = temp__4090__auto___15915;buffer.append([cljs.core.str(replacement_15916)].join(''));
} else
{buffer.append(ch);
}
{
var G__15917 = (index + 1);
index = G__15917;
continue;
}
}
