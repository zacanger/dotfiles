...
1. you are given two methods: getClasses, which gets all of the class names of an element,  and getChildren, which get all of the children of an element.
...
2.  You just got a job for a business owner who wants to redo his website.  He owns 20,000 stores in the US and has 3 different types of stores: retail, grocery, & restaurants.  He wants a map of the US on his landing page that shows all of his stores as pins (think google) so that people are wow’d with how many stores there are.  He asks you if you can see any problems with this (user interaction or functionality).

        part 2:  Once you give your answer to the first part, he agrees to only have 300 stores on the map.  He wants them evenly distributed on the map, and he wants 100 of each store type.  How would you code that?
...
I CAN HIRE YOU OR HIRE 3 PEOPLE IN MEXICO. ARE YOU REALLY WORTH MORE THAN 3 DEVELOPERS IN MEXICO?  --lol QUE ES MAS FUERTE?? -rob --- this was a crazy question -daniel
...
Write JS, HTML and CSS code to allow user to click on one of the blue thumbnails of an employee below and have it blow up to the position of “pane1”, while right sliding the existing pane 1 and pane 2 to the position of pane 2 and 3. In addition to the Javascript pane sliding functionality, please spend some time to make the animation of the sliding action look smooth, and layout beautiful. Must be working code. Please reply and return your results via email to me within 24 hours.
